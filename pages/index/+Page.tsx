...
export default function Page() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: "Музыкальное пространство, где каждая мелодия становится небольшим сюрпризом. Просто покрутите пластинку и позвольте музыке выбрать настроение этого дня.",
      url: document.URL,
    };
