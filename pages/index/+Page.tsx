...
const songs: Song[] = [
  ...
  { songText: "Меланхолично <br /> о личном", songLink: song2, songImage: petal2 },
  { songText: "Вечер домашнего эстета", songLink: song3, songImage: petal3 },
  { songText: `В такси <br /> на late drink`, songLink: song4, songImage: petal4 },
  { songText: "Маэстро семейных завтраков", songLink: song5, songImage: petal3 },
  { songText: "В двух словах <br /> не расскажешь", songLink: song6, songImage: petal4 },
  { songText: "Автостопом <br />  по вишлистам", songLink: song7, songImage: petal2 },
];
      ...
      <div className=" bg-bg flex flex-col 2xl:flex-row  min-h-screen overflow-hidden 2xl:h-[1140px] relative">
        <div className="px-[25px] sm:p-0 shrink-0 z-10">
          <div className="flex items-center justify-between mt-[25px]">
            ...
            <button
              className="bg-white animate-pulsebtn xs:w-[140px] xs:h-[100px] w-[75px] h-[50px]  sm:mr-[45px] flex items-center justify-center rounded-[80px]"
              onClick={handleShare}
            >
              <svg
                width="98"
                ...
                className="xs:w-[45px] xs:h-[35px] w-[31px] h-[26px]"
              >
                <path
        ...
        <div className="2xl:ml-[95px] 2xl:ml-[101px] mt-[40px] 2xl:w-[560px]  flex items-center justify-center flex-col">
          <p className="font-normal text-[16px] leading-[120%] sm:text-[50px]  text-main-text text-center 2xl:text-left">
            Мелодия этого дня
          </p>
          <div className="w-[75%] h-[575px] bg-[#E0D0C080] rounded-[25px] mt-[25px] relative ">
            <p
              dangerouslySetInnerHTML={{ __html: song?.songText }}
              className="font-bold h-[225px] p-[10px] text-[24px] sm:text-[40px] mt-[22px] leading-[120%] text-main-text text-center 2xl:text-left"
            ></p>
            <img
              src={song?.songImage}
              alt=""
            ...
            <div className="absolute top-[calc(50%)] sm:top-[calc(50%)] left-[calc(50%)] translate-[-50%] z-10">
              ...
              <button
                className="w-[95px] h-[95px] flex items-center justify-center bg-white rounded-full text-main-btn font-bold text-[60px] cursor-pointer absolute top-[calc(50%)] left-[calc(50%)] translate-[-50%]"
                onClick={handlePlayClick}
              >
                {isPlay ? (
                  <svg width="23" height="36" viewBox="0 0 23 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.742947" y="0.788086" width="5.71479" height="34.6062" fill="#645349" />
                    <rect x="16.9348" y="0.788086" width="5.71479" height="34.6062" fill="#645349" />
                  </svg>
                ) : (
                  <>
                    <span className="animate-pulsedmobile lg:animate-pulsed w-[95px] h-[95px] rounded-full  block absolute top-[50%] left-[50%] border-7 border-white shadow-white translate-[-50%]"></span>
                    <span className="animate-pulsedmobile lg:animate-pulsed w-[95px] h-[95px] rounded-full  block absolute top-[50%] left-[50%] border-7 border-white shadow-white translate-[-50%] anim-delay-1"></span>
                    <span className="relative z-5">
                      <svg width="26" height="32" viewBox="0 0 26 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M25.6963 16.091L0.196288 31.3346L0.196289 0.847447L25.6963 16.091Z" fill="#645349" />
                      </svg>
                    </span>
                  </>
                )}
            ...
            <div>
              ...
              <progress
                ...
                ref={progressRef}
                className={clsx(
                  "w-[85%] h-[10px] rounded-[30px] [&::-webkit-progress-bar]:bg-[#F3EEEA] [&::-webkit-progress-value]:bg-[#C5AC90] absolute top-[67%] left-[50%] translate-x-[-50%] opacity-0 transition-opacity duration-200 overflow-hidden",
                  { "opacity-100": isPlay },
                )}
              ></progress>
            </div>
            <div className="absolute bottom-0 w-[100%]">
              <p className="font-normal text-[16px] leading-[120%] mt-[67px]  text-main-text text-center 2xl:text-left">
                А здесь можно скачать
                <br />
                милые открытки
                <br />
        ...
        {isSpinEnd && (
          <div className="mt-[25px] mb-[25px] text-center px-14">
            <p className="font-medium text-[10px] sm:text-[19px] leading-[140%] text-main-text">
              Музыку сочинила команда SG
              <br /> для вашего особенного настроения!
            </p>
  ...
  return (
    <div className=" bg-bg flex flex-col lg:flex-row  min-h-screen  overflow-hidden lg:h-[100vh] gap-[10px] relative">
      ...
      {!isSpinEnd && (
        <>
          <div
            className="relative lg:absolute right-0 2xl:right-[50px] top-0  cursor-pointer lg:overflow-hidden z-1"
          ...
          >
            ...
            <img
              ...
              loading="eager"
              alt=""
              className="absolute h-[120vw] lg:h-[120vh] top-[25vw]  lg:top-[17vh] 2xl:top-[20vh] right-[-5vw]  lg:right-[0] 2xl:right-[0] scale-y-[-1] rotate-[25deg] drop-shadow-[40px_40px_45px_#00000033]"
            />
            <div
              className={clsx(
